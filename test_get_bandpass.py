...
for name in open('/public/home/yuanmao/test/test.list', 'r'):
    print name
    filename = '/public/home/data/psr/201801/02/' + name
...
#    show()
         ...
         np.savetxt('/public/home/yuanmao/test/''%s' %basename + ".txt", data1, fmt='%d')
